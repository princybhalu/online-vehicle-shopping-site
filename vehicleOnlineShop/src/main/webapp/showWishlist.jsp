...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; font-size : 20px; ">
      ...
      <div class="text-center fs-4" style="font-size: 18px; margin-top: 20px; ">WishList</div>
...
int pid = 0, flag = 0 ;
try{
Configuration cfg = new Configuration().configure().addAnnotatedClass(Wishlist.class);			
...
java.util.List li = session1.createQuery("from  Wishlist where uid=" + id ).list();
@SuppressWarnings("rawtypes")
java.util.Iterator it=li.iterator();

while(it.hasNext()) {
	Object o = (Object)it.next();
	Wishlist r = (Wishlist)o;
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <% if(rs.getStock() != 0){ %>
           <p class="card-text"><small class="text-muted">Available Stock</small></p>
           <% }else{ %>
             <p class="card-text "><small class="text-Danger" ><FONT COLOR="#ff0000"> Out Off Stock*</FONT></small></p>
             <% } %>
